...
<div class="twinkling">
  <center><br><br><br>
    ...
    <font face="Play">
      <p class="we-are"><b><font color="cyan"><font color="white">;</b></p>
    </font>
  </center>
</div>
<div class="clouds">
...
const phrases = [
  'Aku suguhan kau perasaaku.',
  'Sepiring penuh kau habiskan tanpa sisa.',
  'Hatimu mencubit kekenyangan.',
  'Sialnya, kau pergi tanpa menyisakan,','Makanan untuk kusuguhi ke orang lain.,'
...
var app = {
  ...
  chars: ['cuma temen smp','sumpah rasyid jahat','udah engak ada apa apa lagi sama dia lasing','berisik!!','','maaf','','sakit banget tau','iya rasyid','dih','Janji ini jak saya ulagin','Banyak cowo yang saya like','rasyid kenpa','ngak mungkin saya unfoll','belom move on ngapain nyari rumah baru','kan rasyid udah bosen','saya rela ulfoll cowo cowo di ig demi rasyid','ngak jadi dah','rahasia'],
